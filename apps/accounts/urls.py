...
urlpatterns = [
    ...
    path('contrasena_restablecer/',
         auth_vies.PasswordResetView.as_view(success_url=reverse_lazy('accounts:password_reset_done'),
    ...
    path('contrasena_restablecer_terminado/',
         auth_vies.PasswordResetCompleteView.as_view(),
