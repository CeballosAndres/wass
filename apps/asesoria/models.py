...
class Asesoria(models.Model):
    ...
    descripcion = models.TextField('Descripción', null=True, blank=False)
    requisitos = models.TextField('Requisitos previos a la asesoría', null=True, blank=True)
    comentario_finalizada = models.TextField('Comentarios: asesoría finalizada', null=True, blank=False)
    razon_cancelada = models.TextField('Razón de cancelación', null=True, blank=False)
    razon_rechazada = models.TextField('Razón de rechazo', null=True, blank=False)
